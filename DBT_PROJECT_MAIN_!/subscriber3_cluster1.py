...
SUBSCRIBE_TOPIC = "cluster1" 
PUBLISH_TOPIC = "subscriber31" 
...
def publish_to_kafka(data):
    """Publish the received data to the `subscriber31` topic."""
    try:
...
def run_flask():
    app.run(host="localhost", port=4007)  
